...
class Cms_AdminController extends Tiger_Controller_Action
{
    public function init ( )
    {
        ...
        $this->view->headLink()->appendStylesheet( Tiger_Cache::version('/assets/oneui/js/plugins/summernote/summernote-bs4.css' ) );
        ...
        $this->view->inlineScript()->appendFile( Tiger_Cache::version( '/assets/oneui/js/plugins/summernote/summernote-bs4.min.js' ) );
    ...
    protected function _setThemeOptions ( )
    {
        ...
        $template->inc_side_overlay           = true;
        $template->inc_sidebar                = true;
        $template->inc_header                 = true;
        $template->inc_footer                 = true;
