 ...
 *
 * A convenience plugin used to show relative password strength.
 * This plugin has a number of moving parts and requires the
 * Tiger_Validate_Strength library component, password.ini,
 * and the translated HTML template. See the Tiger docs for usage.
 *
 * @version 2.0.0
 */
