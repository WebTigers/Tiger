...
/**
 * Attach the iconSelector to a hidden input element wrapped by
 * the Bootstrap form group wrapper.
 *
 * <div class="form-group">
 *     <input id="icon-css" name="icon-css" type="hidden" value="" />
 * </div>
 */
...
(function( $ ){
    ...
    let Class = {
        ...
        initElement : function ( ) {
            ...
            $('body').on('keyup', '#icon-search', Class.populateIcons );
    ...
    $.fn.tigerIconSelect = function( method ) {
        if ( Class[method] ) {
