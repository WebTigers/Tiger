...
class Core_Model_Base extends Zend_Db_Table_Abstract {
    ...
    public function createNewRow ( Array $data = [] ) {
        ...
        /** Creates a new Zend DB Table Row tied to a DB table's new record. */
    ...
    public function createUpdateRow ( Array $data = [] ) {

        /** Creates a new Zend DB Table Row tied to a DB table's existing record. */
        $updateRow = $this->createRow( $data );
        ...
        $updateRow->update_date    = $timestamp;
        $updateRow->update_user_id = $user_id;
